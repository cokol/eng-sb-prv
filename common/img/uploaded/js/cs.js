...
$(document).ready(function($){	
	...
	var tables_file = new Array(
		...
		'../../../../../common/img/uploaded/files/deposits_csv/save_online-15052013.csv',
		'../../../../../common/img/uploaded/files/deposits_csv/save-15052013.csv',
		'../../../../../common/img/uploaded/files/deposits_csv/add_online-15052013.csv',
		'../../../../../common/img/uploaded/files/deposits_csv/add_15052013.csv',
		'../../../../../common/img/uploaded/files/deposits_csv/control_online-15052013.csv',
		'../../../../../common/img/uploaded/files/deposits_csv/control-15052013.csv'
	); 
/*
			...
			success: function(msg){
				...
				for( currency_index = 0, currency_length = currency_array.length; currency_index < currency_length; currency_index++){
					...
					for( time_index = 0, time_length = time_array[currency_index].length; time_index < time_length; time_index++){
							table_text = table_text + '<th>' + time_array[currency_index][time_index][0] + '</th>';
					}
				...
				if( contribution_capital_array.length ){
					...
					for( currency_index = 0, currency_length = currency_array.length; currency_index < currency_length; currency_index++){
						...
						for( time_index = 0, time_length = time_capital_array[currency_index].length; time_index < time_length; time_index++){
								table_text = table_text + '<th>' + time_capital_array[currency_index][time_index][0] + '</th>';
						}
						table_text = table_text + '<th class="emt"></th></tr><tr class="top"><td colspan="10"></td></tr>';
