$(document).ready(function() {	
	...
	$("div.slider_chooser a").click(function(){
		$(this).closest("div.sbol_sbol_cases").find("div.slider_chooser a").removeClass("active");
		$(this).closest("div.sbol_sbol_cases").find('div.sbol_sbol_slider_wrapper').hide();
		$(this).closest("div.sbol_sbol_cases").find('div.sbol_sbol_slider_wrapper .cycle-slideshow-my').cycle('destroy');
		var idx = $(this).closest("div.slider_chooser").find('a').index(this);
		$(this).closest("div.sbol_sbol_cases").find("div.sbol_sbol_slider_wrapper").eq(idx).show();
		$(this).closest("div.sbol_sbol_cases").find("div.sbol_sbol_slider_wrapper").eq(idx).find('.cycle-slideshow-my').cycle();
...
$(window).scroll(function() {
		...
		var offsetsideBlock = $("div.sbol_sbol_cases").offset().top-255;
